...
while not done:
    ...
    for i in range (100, 600, 125):
        pygame.draw.ellipse(screen, WHITE, [i, 60, 60, 30], 0)
        pygame.draw.ellipse(screen, WHITE, [i+40, 60+15, 60, 30],0)
        pygame.draw.ellipse(screen, GREY, [i + 50, 60-5, 60, 30], 0)
